# Generated by Django 4.1.1 on 2023-02-03 20:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Packed', 'Packed'), ('Acepted', 'Accepted'), ('Pending', 'Pending'), ('Cancel', 'Cancel'), ('Delivered', 'Delivered'), ('On The Way', 'On The Way')], default='Pending', max_length=50)),
